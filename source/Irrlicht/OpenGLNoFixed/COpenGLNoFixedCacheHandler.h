...
namespace video
{
	...
	class COpenGLNoFixedCacheHandler : public COpenGLCoreCacheHandler<COpenGLNoFixedDriver, COpenGLTexture>
	{
	public:
		COpenGLNoFixedCacheHandler(COpenGLNoFixedDriver* driver);
		virtual ~COpenGLNoFixedCacheHandler();
