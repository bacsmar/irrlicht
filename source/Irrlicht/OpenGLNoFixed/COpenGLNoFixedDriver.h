...
namespace video
{
	...
	class COGLNoFixedRenderer2D;
	class COpenGLNoFixedCacheHandler;

	class COpenGLNoFixedDriver : public CNullDriver, public IMaterialRendererServices, public COpenGLNoFixedExtensionHandler
	{
		friend class COpenGLCoreTexture<COpenGLNoFixedDriver>;

	public:
		//! constructor
		COpenGLNoFixedDriver(const SIrrlichtCreationParameters& params, io::IFileSystem* io, IContextManager* contextManager);

		//! destructor
		virtual ~COpenGLNoFixedDriver();
		...
		{
			return FeatureEnabled[feature] && COpenGLNoFixedExtensionHandler::queryFeature(feature);
		}
...
//			virtual void drawPixel(u32 x, u32 y, const SColor & color);
		...
		COpenGLNoFixedCacheHandler* getCacheHandler() const;
	...
	private:
		...
		COpenGLNoFixedCacheHandler* CacheHandler;
		COGLNoFixedRenderer2D* MaterialRenderer2D;
